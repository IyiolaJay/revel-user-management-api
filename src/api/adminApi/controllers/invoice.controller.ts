...
export default class InvoiceController extends BaseController {
    ...
    createInvoice = this.wrapAsync(
        async (req: Request, res: Response, _: NextFunction) => {
            ...
            const createdInvoice = await this.invoiceService.CreateInvoice(invoice, id);
    ...
    editInvoice = this.wrapAsync(
        async (req: Request, res: Response, _: NextFunction) => {
            ...
            const invoice = req.body;
            const updatedInvoice = await this.invoiceService.EditInvoice(invoiceId!, invoice);
            this.sendResponse(res, httpStatus.OK, {
                success: true,
    ...
    getNextInvoiceNumber = this.wrapAsync(
        async (req: Request, res: Response, _: NextFunction) => {
            ...
            const nextInvoiceNumber = await this.invoiceService.GetNextInvoiceNumber(invoiceType);
